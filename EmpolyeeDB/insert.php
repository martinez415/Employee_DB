<?php
    ...
    $insert_code='INSERT INTO Employee(EmpLName, EmpFName, EmpAddress1, EmpAddress2, EmpCity, EmpState, EmpZipCode, EmpDept, EmpDOB) 
    VALUES (:last_name, :first_name, :address_line_1, :address_line_2, :city, :emp_state, :zip_code, :department, :dob);';

    $statement=$db->prepare($insert_code);
...
<html>
    ...
    <body>
        <script>
            alert("Employee added. Thank you.")
        </script>
        <div class="ops">
